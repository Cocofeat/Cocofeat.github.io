...
- 👯 I'm looking to collaborate on __Trustworthy multi-modality learning__ with uncertainty estimation, __Explainable VLM with Grounding__, __Multi-agents/Agentic System__, __Foundation model__, __Benchmarking__, and __Hallucination and Fairness in VLM__.
- 📬 I welcome collaborations with researchers, clinicians, and students. I am also recruiting remote __research assistants (RA)__ and __CSC-funded visiting students/PhD applicants__ interested in multimodal AI and medical foundation models.
...
- Journal Reviewer: ***IEEE TMI***, ***Medical Image Analysis***, ***IEEE TNNLS***, ***Signal Processing***, ***Pattern Recognition***, ***Knowledge-Based Systems***, ***Engineering Applications of Artificial Intelligence***, ***Biomedical Signal Processing and Control***, ***IEEE TAI***, ***IEEE JBHI***

# 💬 Talks and Presentations
- *2025.10*, BEIHAI SUMMIT 2025, Beijing, China.
- *2025.09*, MICCAI2025, Daejeon, Republic of Korea.
